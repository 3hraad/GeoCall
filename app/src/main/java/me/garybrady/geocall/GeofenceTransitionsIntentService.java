...
public class GeofenceTransitionsIntentService extends IntentService {
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        phoneNum = settings.getString("PhoneNumber", "0");
     ...
     */
    private void sendNotification(String notificationDetails, int tranID){
        String callForwardString;
        Intent intentCallForward;
        Uri uri2;
        NotificationManager mNotificationManager;
        mNotificationManager = (NotificationManager) getSystemService(Context.NOTIFICATION_SERVICE);
        if(tranID==Geofence.GEOFENCE_TRANSITION_ENTER) {


            callForwardString = "*21*" + phoneNum + "#";

            intentCallForward = new Intent(Intent.ACTION_CALL);
            uri2 = Uri.fromParts("tel", callForwardString, "#");
        ...
        }else if(tranID==Geofence.GEOFENCE_TRANSITION_EXIT) {
            ...
            try {
                ...
                Log.i(TAG,"no notifiaction to cancel");
            }
            if (ActivityCompat.checkSelfPermission(this, android.Manifest.permission.CALL_PHONE) != PackageManager.PERMISSION_GRANTED) {
                // TODO: Consider calling
                //    ActivityCompat#requestPermissions
